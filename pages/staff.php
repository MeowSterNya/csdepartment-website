...
<body>
      ...
      <div class="card-deck">
          <div class="card text-center">
              ...
              <div class="card-footer">
                  ...
                  <td><form><button type="submit" name="staff-edit" class="btn btn-success btn-sm" value="<?php echo $record->ID;?>">Edit</button></form></td>
  ...
  <div class="row justify-content-center align-items-center">
    <form method="post" class="col-5">
      ...
      <div class="form-group">
        <a name="edit-close" class="btn btn-danger" href="staff" role="button">Close</a>
