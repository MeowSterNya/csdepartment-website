...
class ActivityViaAPI {
    ...
    public function __construct() {
        ...
        // get the grandparent dir of our *top-level includer* PHP script ('activity.php')
        ...
        $this->service_api_url = "http://" . $home_server . $grandparentDir . 
                                     "site_api/category_api/activity_api.php";
    ...
    // used when reading data for just one Activity entry
    function readOne() {
    ...
    // read Activitys with pagination
