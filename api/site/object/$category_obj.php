...
class «Category»ViaAPI {
    ...
    public function __construct() {
        ...
        // get the grandparent dir of our *top-level includer* PHP script ('«category».php')
        ...
        $this->service_api_url = "http://" . $home_server . $grandparentDir . 
                                     "site_api/category_api/«category»_api.php";
    ...
    // used when reading data for just one «Category» entry
    function readOne() {
