...
if ( $bGetAll ) {
    $result_data = "<h1>Activity List</h1>";
        ...
        foreach ( $all_records as $record ) {
            ...
            $result_data .= "<tr>" . 
                "<td>" . "Name:" . "<br/>" . 
                         $record->name . "</td>" . 
                "<td>" . "Details:" . "<br/>" . 
                         '<a href="activity.php?id=' .  $record->id . '"' . 
    ...
    $result_data = "<h1>Activity Details</h1>";
...
echo "<!DOCTYPE html>" . 
     "<html>" . 
     "<head>" . 
     "<title>" . ( $bGetAll ? "Activity List" : "Activity Details" ) . "</title>" . 
     '<meta charset="utf-8">' . 
     "</head>" . 
     "<body>" . 
     $result_data . 
